...
TEST_CASE("Aloe test vectors") {
    SECTION("Aloe test vectors 1 (Basic)") {
    ...
    SECTION("Aloe test vector 2 (Augmented, aggregate of aggregates)") {
    ...
    SECTION("Aloe test vector 3 (PoP)") {
